...
const AddRestaurant = ({fetchMyRestaurant}:props) => {
    ...
    const handleSubmit = async() => {
        ...
        formData.append("formatedAddress",String(location.formattedAddress))
  ...
  return (
    <div className="min-h-screen bg-gray-500 px-4 py-6">
        <div className="mx-auto max-w-lg rounded-xl bg-white p-6 shadow-sm space-y-5">
            ...
            className="w-full rounded-lg border px-4 py-2 text-sm outline-none" />
             <input type="text" placeholder="Restaurant Description..." value={description} onChange={e => setDescription(e.target.value)} 
            className="w-full rounded-lg border px-4 py-2 text-sm outline-none" />


            <label className="flex cursor-pointer items-center gap-3 rounded-lg border p-4 text-sm text-gray-500 hover:text-gray-50">
            ...
            <div className="flex items-start gap-3 rounded-lg border p-4">
                ...
                <div className="text-sm">
                    {
                        loadingLocation?"Fetching your loaction" : location?.formattedAddress || "loaction not avaliable"
                    }
