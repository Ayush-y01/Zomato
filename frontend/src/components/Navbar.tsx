  ...
  return (
    <div className="w-full bg-white shadow-sm">
        ...
        <div className="flex items-center gap-4">
            ...
            rounded-full bg-[#E23744] text-xs font-semibold text-white">
                {quantity}
                </span>
            </Link>
            {
                isAuth ?( <Link to={"/account"} className="font-medium text-[#E23744]" >Account</Link>
        ...
        isHomePage && <div className="border-t px-4 py-3">
            <div className="mx-auto flex max-w-7xl items-center rounded-lg border shadow-sm">
                <div className="flex items-center gap-2 px-2 border-r text-gray-700">
                ...
                <input type="text" placeholder="Search For restaurant" value={search} onChange={e =>setSearch(e.target.value)}
