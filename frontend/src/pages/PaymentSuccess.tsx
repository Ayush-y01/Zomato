  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-4 ">
        <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-sm text-center space-y-4">
            ...
            <p className="text-sm text-gray-500">Your Order Has Been placed Succssfully </p>
            ...
            <div className="space-y-2 pt-2 ">
                ...
                bg-[#e23744] py-3 text-sm font-semibold text-white " onClick={() => navigate("/")}>
                    Order more <BiArrowToRight size={16} />
                </button>
                <button className="flex w-full items-center justify-center gap-2 rounded-lg 
                bg-[#e23744] py-3 text-sm font-semibold text-white " onClick={() => navigate("/orders")}>
                    Your Orders <BiArrowToRight size={16} />
                </button>
            </div>
        </div>
    </div>
