...
const Checkout = () => {
  ...
  const grandTotal = subTotal + playfromFee + deliveryFee
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-6 space-y-6">
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm space-y-3">
        ...
        {
          loadingAddress ? <p className="text-sm text-gray-500">Loading Addresses</p>
            : address.length ===0 ? <p className="text-sm text-gray-500">No Address Found!!!!</p> : address.map((add) => (
              <label key={add._id} className={`flex gap-3 rounded-lg border p-3 cursor-pointer
        ...
        <div className="rounded-xl bg-white p-4 shadow-sm space-y-3">
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#2D7FF9] py-3 
          text-sm font-semibold text-white :hover:bg-blue-500 disabled:opacity-50 ">
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-black py-3 
          text-sm font-semibold text-white :hover:bg-gray-800 disabled:opacity-50 ">
            {loadingRazorpay ? <BiLoader size={18} className="animate-spin"/> 
